                ...
                <div className={styles.commentContent}>
                    <header>
                        <div className={styles.authorAndTime}>
                            ...
                            <time title="18:35 de 23 de Dezembro de 2023" dateTime="2023-12-23 18:35:00">Cerca de 1h atrás</time>
                        </div>
